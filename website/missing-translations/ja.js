...
module.exports = {
	...
	IfYouWouldLikeToContributeYourOwnTranslationOrHelpUsFixThisIssue: 'もし独自の翻訳を提供していただくか、問題を修正していただける場合は、弊社の{0}GitHubリポジトリ{/0}で新しい{1}プルリクエスト{/1}を作成してください。ご協力いただきありがとうございます！ o(>ω<)o',
